...
try:
    ...
    sql = "INSERT INTO locations (location_id, street_address,postal_code, city, state_province, country_id) VALUES (%s, %s, %s, %s, %s, %s)"
    val = (location_id, street_address, postal_code, city, state_province, country_id)
    cur.execute(sql, val)
